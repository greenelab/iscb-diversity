...
t.test(f_iscb, f_pub, alternative = 'greater') %>% 
  broom::tidy() %>% 
  select(-contains('estimate')) %>% 
  print()
```
Taking all the years together, the Welch two-sample one-sided t-test does not reveal any difference in the mean probability of ISCB speakers predicted to be female compared to that of authors (p = 0.226).
