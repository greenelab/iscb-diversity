...
t.test(w_iscb, w_pub) %>% 
  ...
  print()
```
A Welch two-sample t-test also does not reveal any difference between the mean probability of ISCB speakers predicted to be in Other categories compared to authors.
