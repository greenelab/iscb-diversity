...
# save(nationalize_df, file = 'Rdata/nationalize_df.Rdata')
load('Rdata/nationalize_df.Rdata')
...
pubmed_nat_df <- pubmed_nat_pmids %>%
  ...
  ungroup()
save(pubmed_nat_pmids, pubmed_nat_df, file = 'Rdata/pubmed_nat_df.Rdata')

# load('Rdata/pubmed_nat_df.Rdata')
...
top_names <- map_dfc(nationalize_df %>% 
...
```{r}
# save(my_world, iscb_pubmed_oth, pubmed_nat, iscb_nat, file = 'Rdata/iscb-pubmed_nat.Rdata')
```
