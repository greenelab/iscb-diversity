...
```{r}
nationalize_df <- read_tsv('https://raw.githubusercontent.com/greenelab/wiki-nationality-estimate/24c8508d47ccb0f5f08ebf99b745fea2389ccf6a/data/LSTM_results_authors.tsv') %>% 
  rename('full_name' = X1) %>% 
