...
fig_2_a_d <- cowplot::plot_grid(fig_2a, fig_2c, fig_2b, fig_2d, ncol = 2, 
                                labels = 'AUTO', 
                                rel_widths = c(year(end_year) - 1990, year(end_year) - 1985))
...
ggsave('figs/us_racial_makeup.svg', fig_2, width = 7, height = 7.5)
```
