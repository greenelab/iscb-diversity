...
Before 2002, `r pred_before_2002[1, 'n']` authors had gender predictions, `r pred_before_2002[3, 'n'] + pred_before_2002[2, 'n']` didn't have gender predictions, `r pred_before_2002[3, 'n']` of these authors only have initials for fore names.
...
`pubmed_nat_pmids %>% filter(is.na(African)) %>% nrow()` pubmed full names not nationalized.
