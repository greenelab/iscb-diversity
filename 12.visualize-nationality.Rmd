...
Therefore, we do not have prediction for nats before this year.
...
fig_3d <- bind_rows(iscb_nat) %>%
  region_breakdown(category = 'sub', journal)

# left_col <- cowplot::plot_grid(fig_3a, fig_3b, labels = c('A', 'B'), nrow = 2)
# fig_3 <- cowplot::plot_grid(left_col, fig_3c, labels = c('', 'C'), ncol = 2)
fig_3_a_d <- cowplot::plot_grid(fig_3a, fig_3b, fig_3c, fig_3d, labels = 'AUTO')
# fig_2 <- cowplot::plot_grid(fig_2_a_d, fig_stats, labels = c('', 'E'), ncol = 1, rel_heights = c(2,1))
fig_3_a_d
ggsave('figs/region_breakdown.png', fig_3, width = 7, height = 5)
...
fig_3s
ggsave('figs/region_sup.png', fig_3s, width = 6.5, height = 5)
```
